...
if(window.jQuery){
easyloader.load(["parser","form","datagrid"],function(){
jQuery.parser.auto = false;
jQuery.parser.onComplete=function(){
    jQuery(".easyui-wrapper").removeClass("easyui-wrapper");
    jQuery("table.easyui-datagrid").each(function (i) {
        jQuery(this).datagrid("resize");
    });	
}
jQuery.parser.parse();
});
